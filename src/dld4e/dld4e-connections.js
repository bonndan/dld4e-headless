var drawConnections = function (svg, diagram, connections, icons, notes) {
  ...
  connections.forEach(function (connection, index) {
    ...
    svg.append("text")
      ...
      .attr("xlink:xlink:href", "#" + pathName) //workaround for https://github.com/d3/d3-selection/issues/94
      .text(firstLabel);
...
module.exports.drawConnections = drawConnections;